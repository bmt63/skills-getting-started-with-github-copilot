...
activities = {
    ...
    "Soccer Practice": {
        "description": "Team drills and scrimmages for aspiring soccer players",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Improve shooting, passing, and teamwork on the court",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["tyler@mergington.edu", "kayla@mergington.edu"]
    },
    "Art Workshop": {
